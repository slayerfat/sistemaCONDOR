...
@section('css')
  <link rel="stylesheet" type="text/css" href="vendor/css/bootstrap-table/bootstrap-table.css">
@stop
...
@section('js')
  <script src="vendor/js/bootstrap-table/bootstrap-table.js"></script>
  <script src="vendor/js/bootstrap-table/bootstrap-table-es-CR.js"></script>
@stop
